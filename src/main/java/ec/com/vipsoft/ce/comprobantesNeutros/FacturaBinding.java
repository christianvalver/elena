...
//@Entity
public class FacturaBinding extends BaseComprobanteElectronicoBinding implements Serializable{
	...
	public void addDetalle(FacturaDetalleBinding facturaDetalleBinding) {
		getDetalles().add(facturaDetalleBinding);		
	}

	public void addDetalle(String codigo, String descripcion, String infoAdicional, int cantidad, int valorUnitario) {
		addDetalle(new FacturaDetalleBinding(codigo,descripcion,infoAdicional,cantidad,valorUnitario));	
	}
}
