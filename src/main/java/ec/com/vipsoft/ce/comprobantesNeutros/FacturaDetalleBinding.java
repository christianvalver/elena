...
public class FacturaDetalleBinding implements Serializable{
	...
	protected BigDecimal valorUnitario;
    	...
    	public FacturaDetalleBinding(String codigo, String descripcion,String infoAdicional) {
    		this();
    		setCodigo(codigo);
    		setDescripcion(descripcion);
    		setCantidad(1);
    		setValorUnitario(0);
    		setInfoAdicional1(infoAdicional);
    	}
    	
        public FacturaDetalleBinding(String codigo, String descripcion) {
    		this();
    		setCodigo(codigo);
    		setDescripcion(descripcion);
    		setCantidad(1);
    	...
    	public FacturaDetalleBinding(String codigo, String descripcion, String infoAdicional, int cantidad, int precio) {
    		this(codigo,descripcion,infoAdicional);
    		setCantidad(cantidad);
    		setValorUnitario(precio);
    	}

    	public FacturaDetalleBinding(String codigo, String descripcion, String infoadiciona, int cantidad) {
    		this(codigo,descripcion,infoadiciona);
    		setCantidad(cantidad);
    		setValorUnitario(0);
    		calcularIva();
    		calcularValorTotal();
...
//	}
	...
	public void calcularIva() {
		baseImponible=calculaBaeImponible();
		if(codigoIVA.equalsIgnoreCase("2")){
	...
	public void setCantidad(int i) {
		setCantidad(new BigDecimal(i));
		
	}

	public void setValorUnitario(int i) {
		setValorUnitario(new BigDecimal(i));		
	}
}
